const CACHE='compasso-static-v28';
self.addEventListener('install',e=>e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['index.html','style.css','crop.css','workflow.css','finance.css','mobile-fixes.css','camera.css','data-v2.js','firebase.js','app.js','manifest.json','privacy.html','icons/icon-192.png','icons/icon-512.png','assets/teacher-demo.png','assets/students-demo.png','assets/book-demo.png'])).then(()=>self.skipWaiting())));
